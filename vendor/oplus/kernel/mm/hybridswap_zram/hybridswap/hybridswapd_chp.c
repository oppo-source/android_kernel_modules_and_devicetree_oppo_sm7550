...
static int inbalance_base_factor = 30;
static int chp_over_compressed_ratio = 150; /* zram1 vs anon hugepages: 1.5 vs 1*/
static int inbalance_chp_factor = 15;
static int shallow_cma_pool_factor = 2; /* cma pool is less than 2 * high */
module_param_named(inbalance_base_factor, inbalance_base_factor, int, S_IRUGO | S_IWUSR);
module_param_named(chp_over_compressed_ratio, chp_over_compressed_ratio, int, S_IRUGO | S_IWUSR);
module_param_named(inbalance_chp_factor, inbalance_chp_factor, int, S_IRUGO | S_IWUSR);
module_param_named(shallow_cma_pool_factor, shallow_cma_pool_factor, int, S_IRUGO | S_IWUSR);
